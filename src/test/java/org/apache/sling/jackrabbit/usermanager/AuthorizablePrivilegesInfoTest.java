...
public class AuthorizablePrivilegesInfoTest {
    ...
    public void testConvertDeprecated() {
        assertEquals(
                ...
                PropertyUpdateTypes.convertDeprecated(PropertyUpdateTypes.addProperty));
        assertEquals(
                PropertyUpdateTypes.ADD_NESTED_PROPERTY,
                PropertyUpdateTypes.convertDeprecated(PropertyUpdateTypes.addNestedProperty));
        assertEquals(
                PropertyUpdateTypes.ALTER_PROPERTY,
                PropertyUpdateTypes.convertDeprecated(PropertyUpdateTypes.alterProperty));
        assertEquals(
                PropertyUpdateTypes.REMOVE_PROPERTY,
                PropertyUpdateTypes.convertDeprecated(PropertyUpdateTypes.removeProperty));
